/* offline shell · v34（v33 基础上只升版本号，强制用户拉到新 index.html）
   本次重点：v9.1多维表格下载板块改为按 V9.1 多维表格原表结构
   只导出 sheet 2「合同详情」+ sheet 3「出入库」，按金山文档 schema 字段顺序铺 xlsx
   后端新增 /api/v91/raw?sid=2|3 端点（鉴权 X-Webhook-Token）返回 raw records + schema */
const C='gzt-v34';
