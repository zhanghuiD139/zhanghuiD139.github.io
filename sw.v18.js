/* offline shell · v18（清掉 v17 及之前所有缓存 + 主动清理历史残留的跨域缓存条目）
   本次重点：V9.1「本机 server」直写是跨域 POST。
   旧版（≤v16）会把跨域响应写进 Cache Storage，导致「第一次真发、之后命中缓存不再真发」。
   v17 起已对跨域请求直接 return，交给浏览器原生网络栈，永不入缓存；v18 仅升缓存名强制用户刷新到新版本。
