...
self.addEventListener('activate',e=>{
  // 删除所有旧版本缓存（含 gzt-v1~v8 任意名），保证不残留冻结的旧 index.html / data.json
